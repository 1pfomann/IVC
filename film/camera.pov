...
#declare camera1=camera {
  location <sin(pi*clock*0.5/14)*100, 3, -100>
  look_at <50, 5, 0>
  right x*image_width/image_height
}
...
#declare camera3=camera {
  location<45+sin(pi*clock*0.5/14)*10, 2.5, -4>
  look_at <50, 4, 0>
  right x*image_width/image_height
}
...
#declare camera4=camera {
  location <30+sin(pi*clock*0.5/14)*40, 5, -4>
  look_at <70-sin(pi*clock*0.5/14)*40, 1, -10>
  right x*image_width/image_height
}
...
#declare camera6=camera {
  location<49+sin(pi*clock*0.5/14)*2, 3, sin(pi*clock)*0.5>
  look_at <60-sin(pi*clock*0.5/15)*20, 0, -70>
  right x*image_width/image_height
}

//camera 7: rear area of dancefloor floating forward
#declare camera7=camera {
  location <50, 3, -70+(sin(clock*pi*0.5/14)*67)>
  look_at <50, 3, 0>
  right x*image_width/image_height
}
...
#declare camera8=camera {
  location<5+sin(clock*pi*0.5/14)*90, 10, -195+sin(clock*pi*0.5/14)*190>
  look_at <50, 2, -sin(pi*clock*0.5/14)*200>
  right x*image_width/image_height
}
