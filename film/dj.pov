...
#declare DJ=
  ...
  #declare Intersection_Right_Arm = vnormalize(<4, -5, 10>)*0.300+Intersection_Right_Shoulder;
  #declare Right_Hand = vnormalize(<-1, -1, 4+abs(sin(pi*clock))>)*0.250+Intersection_Right_Arm;
  union {
    // Cap
    union {
      intersection {
